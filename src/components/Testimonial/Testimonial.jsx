...
const Testimonial = () => {
	return (
		<section classname="text-gray-600 body-font mx-auto p-16 bg-coal">
					...
					<div classname="p-4 md:w-1/2 w-full">
						<div classname="h-full bg-gray-700 p-8 rounded">
							...
							<p classname="leading-relaxed text-gray-300 mb-6">
								...
								brunch everyday carry neutra before they sold
								out fixie 90's microdosing. Tacos pinterest
								fanny pack venmo, post-ironic heirloom try-hard
